...
if(!isset($_GET['status']) || $_GET['status'] == "") header("Location: index.php");

switch($_GET['status']){
    case 'success':
        $titulo = "Su compra ha sido completada exitosamente!";
    ...
    break;
    case 'pending':
        $titulo = "Su compra ha sido inciada y está pendiente de pago.";
        $mensaje = "Hemos recibido el inicio del trámite de pago. Por favor complete el pago para concretar la compra.";        
    break;
    case 'failure':
        $titulo = "Pago rechazado.";
        $mensaje = "No se pudo concretar tu pago. Por favor vuelve a intentarlo nuevamente o utiliza otro medio.";
    break;
}
?>
                            ...
                            <div style="width:60%; margin-left:25%;">
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                       <p style="margin-top: 30px;"><?php echo $mensaje ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
